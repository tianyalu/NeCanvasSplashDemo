...
public class SplashView extends View {
    ...
    private void drawCircles(Canvas canvas) {
        ...
        for (int i = 0; i < mCircleColors.length; i++) {
            //x = r * cos(a) + centerX; //参考show/analyse1.png
            //y = r * sin(a) + centerY;
...
//            mValueAnimator.start(); //从圆心处（旋转中心）开始扩散至旋转圆最大半径，然后回到初始状态
            mValueAnimator.reverse(); //从初始状态开始扩散至旋转圆最大半径，然后回到圆心处（旋转中心）
        }
